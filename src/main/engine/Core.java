...
import main.java.audio.screen.*;
import main.java.engine.level.LevelManager;
			...
			switch (returnCode) {
                ...
                case 2:
                    do {
                        ...
                        main.java.engine.level.Level currentLevel = levelManager.getLevel(gameState.getLevel());
